export { PART_CATALOG, partDefSchema, type PartDef, type PartCategory } from './catalog'
export { COLOR_PALETTE, colorDefSchema, type ColorDef, type ColorId } from './colors'
...
const _colorById = new Map<string, ColorDef>(COLOR_PALETTE.map((c) => [c.id, c]))
